          ...
          {userDetails.map((value, index) => (
            <div className="orderStatusPage">
              <div className="orderStatus">
                <div style={{ width: "30%" }}>
                  <p className="orderNumber">Order ID : {value.userorderid}</p>
                </div>
                {value.userpriority && (
                  <div style={{ width: "30%" }}>
              ...
              <div>
                <div>
                  ...
                  <div>
                    ...
                    <div className="detailsDeliveryTime">{value.username}</div>
                    <div className="detailsDeliveryTime">{value.userphone}</div>
                    <div className="detailsDeliveryTime">
                      {value.useraddress}
                    </div>
                  </div>
